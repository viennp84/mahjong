...
var Attribute = /** @class */ (function () {
    function Attribute(_a) {
        var modelKey = _a.modelKey, jsonKey = _a.jsonKey;
...
var AttributeObject = /** @class */ (function (_super) {
    ...
    function AttributeObject(_a) {
        var modelKey = _a.modelKey, jsonKey = _a.jsonKey, itemClass = _a.itemClass;
        var _this = _super.call(this, { modelKey: modelKey, jsonKey: jsonKey }) || this;
...
var AttributeDate = /** @class */ (function (_super) {
    ...
    AttributeDate.prototype.fromJSON = function (val, parent) {
        if (!val) {
            return null;
        }
        return new Date(val);
