...
var RestfulModel = /** @class */ (function () {
    ...
    RestfulModel.prototype.deleteRequestQueryString = function (params) {
        return {};
    };
    // deleteRequestBody is used by delete(). Subclasses should override this method.
    RestfulModel.prototype.deleteRequestBody = function (params) {
        return {};
    };
    ...
    RestfulModel.prototype._get = function (params, callback, path_suffix) {
        if (params === void 0) { params = {}; }
        if (path_suffix === void 0) { path_suffix = ''; }
        var collectionName = this.constructor.collectionName;
        return this.connection
            .request({
            method: 'GET',
